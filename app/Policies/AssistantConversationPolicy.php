...
class AssistantConversationPolicy
{
    ...
    {
        return $assistantConversation->user_id === $user->id;
    }
     ...
     */
    public function restore(User $user, AssistantConversation $assistantConversation): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, AssistantConversation $assistantConversation): bool
    {
        return false;
    }
}
